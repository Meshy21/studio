...
export const projects: Project[] = [
  ...
  },
  {
    ...
    learnings: 'This project was an in-depth exploration of applied AI and embedded systems. I mastered training and deploying YOLO models, working with OCR libraries, and interfacing with custom hardware on a Linux-based platform (Raspberry Pi OS). It was incredibly rewarding to build a complete, end-to-end assistive technology device.',
