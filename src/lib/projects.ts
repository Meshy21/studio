...
export const projects: Project[] = [
  {
    ...
    gallery: [
      { url: images.learnmateGallery1, hint: 'app screenshot' },
      { url: images.learnmateGallery2, hint: 'user profile' },
    ],
  ...
  },
  {
    ...
    gallery: [
      { url: images.woodKnotGallery1, hint: 'detection overlay' },
      { url: images.woodKnotGallery2, hint: 'model analysis' },
    ],
  ...
  },
  {
    ...
    image: images.electricalMonitoringMain,
    imageHint: 'electrical monitoring',
    gallery: [
        { url: images.electricalMonitoringGallery1, hint: 'hardware setup' },
        { url: images.electricalMonitoringGallery2, hint: 'data chart' },
    ],
  ...
  },
  {
    ...
    gallery: [
        { url: images.brailleReaderGallery1, hint: 'device prototype' },
        { url: images.brailleReaderGallery2, hint: 'ocr in action' },
    ],
